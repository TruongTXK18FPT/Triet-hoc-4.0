...
import { Loader2, Wand2, Link as LinkIcon, Save, BookOpen, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-20 left-10 w-64 h-64 bg-amber-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        <div className="absolute top-40 right-10 w-64 h-64 bg-rose-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-40 w-64 h-64 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
              ...
              <Form {...form}>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base font-semibold text-amber-900">Trình độ hiện tại</FormLabel>
                        <Select
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base font-semibold text-amber-900">Mục tiêu học tập</FormLabel>
                        <FormControl>
                          <Textarea
                      ...
                      <div className="space-y-6">
                                            ...
                                            return (
                                              <a 
                                                ...
                                                className={`
                                                  ...
                                                  ${isUrl ? 'text-amber-700 hover:text-amber-900' : 'text-foreground/70'}
                                                `}
                                              >
                        ...
                        <div className="relative p-5 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200">
                          <div className="flex gap-3">
                            ...
                            <div>
                              <h4 className="font-semibold text-blue-900 mb-1">💡 Gợi ý học tập</h4>
                              <p className="text-sm text-blue-800/80 leading-relaxed">
                                Đánh dấu hoàn thành từng mục để theo dõi tiến độ. 
                                Nhấn <strong>Lưu Lộ Trình</strong> để lưu vào hồ sơ và xem lại bất cứ lúc nào.
                              </p>
                            </div>
                          </div>
                        </div>
