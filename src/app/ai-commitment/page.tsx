...
import { Shield, Heart, Lock, Eye, BookOpen, AlertCircle, Mail, Sparkles } from 'lucide-react';
...
const commitments = [
  {
    ...
    quote: '"AI phục vụ tri thức – tri thức phục vụ con người." Đó là triết lý vận hành cốt lõi của Triết học 4.0.',
  ...
  },
  {
    ...
    content: [
      'Chúng tôi tuyệt đối tuân thủ các nguyên tắc đạo đức AI:',
    ],
    points: [
        ...
        <div className="container mx-auto px-4 py-12 md:py-20">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="font-headline text-3xl md:text-5xl font-bold text-primary mb-6 max-w-4xl mx-auto">
              Cam kết sử dụng Trí tuệ Nhân tạo một cách có trách nhiệm và nhân văn
            </h1>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            {commitments.map((section, index) => {
              ...
              return (
                <Card key={index} className="bg-white/95 backdrop-blur shadow-2xl border-2 border-slate-200">
                  <CardContent className="p-8 md:p-12">
                    <div className="flex items-start gap-4 mb-6">
                      <div className={`h-14 w-14 rounded-xl bg-gradient-to-br ${section.color} flex items-center justify-center flex-shrink-0 shadow-lg`}>
                        <Icon className="h-7 w-7 text-white" />
                      </div>
                      <div className="flex-1">
                        <h2 className="text-2xl md:text-3xl font-bold text-primary mb-4">🧭 {section.title}</h2>
                        {section.content.map((text, i) => (
                          <p key={i} className="text-lg text-slate-700 leading-relaxed mb-3">
                            {text}
                          </p>
                        ))}
                      </div>
                    ...
                    {section.points && (
                      <div className="space-y-3 mt-6">
                        {section.points.map((point, i) => (
                          <div key={i} className="p-4 bg-gradient-to-r from-slate-50 to-blue-50 rounded-lg border-l-4 border-blue-400">
                    ...
                    {section.quote && (
                      <div className="mt-6 p-6 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border-2 border-amber-300">
                        <p className="text-xl text-amber-900 italic font-medium">{section.quote}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
            ...
            <Card className="bg-white/95 backdrop-blur shadow-2xl border-2 border-slate-200">
              <CardContent className="p-8 md:p-12">
                <h2 className="text-3xl font-bold text-primary mb-6">🔬 4. Cách chúng tôi sử dụng AI</h2>
                <p className="text-lg text-slate-700 mb-6">Triết học 4.0 sử dụng AI trong các lĩnh vực:</p>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    { icon: '💬', title: 'Chatbot triết học', desc: 'Giúp người học đối thoại, thảo luận về triết học, kinh tế học, chủ nghĩa xã hội khoa học.' },
                    { icon: '📖', title: 'Tóm tắt tri thức', desc: 'Hỗ trợ tổng hợp nội dung, giải thích khái niệm phức tạp bằng ngôn ngữ dễ hiểu.' },
                    { icon: '🧩', title: 'Hỗ trợ học tập', desc: 'Gợi ý bài đọc, khái niệm liên quan, ví dụ thực tiễn, hoặc kết nối triết học với các lĩnh vực khác.' },
                    { icon: '✨', title: 'Truyền cảm hứng', desc: 'Giúp sinh viên tìm thấy niềm yêu thích trong việc học triết học và khoa học xã hội.' },
                  ].map((item, i) => (
            ...
            <Card className="bg-white/95 backdrop-blur shadow-2xl border-2 border-amber-200">
              <CardContent className="p-8 md:p-12">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-primary mb-4">🧠 5. Giới hạn của AI</h2>
                    <p className="text-lg text-slate-700 font-semibold mb-4">
                      AI không phải là nhà triết học – nó là người bạn đồng hành triết học.
                    </p>
                    <p className="text-lg text-slate-700 mb-4">Vì vậy, chúng tôi luôn nhắc nhở người học rằng:</p>
            ...
            <Card className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-2xl">
              <CardContent className="p-8 md:p-12">
                ...
                <h2 className="text-3xl font-bold mb-4">🌍 6. Hướng đến tương lai</h2>
                <p className="text-xl mb-6">
                  Chúng tôi không chỉ phát triển một công cụ, mà là một phong trào giáo dục nhân văn trong kỷ nguyên trí tuệ nhân tạo.
                </p>
                <p className="text-lg mb-4">Triết học 4.0 mong muốn cùng cộng đồng giáo dục, giảng viên, sinh viên và nhà nghiên cứu:</p>
                <div className="space-y-2 text-lg">
                  <p>✓ Xây dựng chuẩn mực AI học thuật tại Việt Nam</p>
                  <p>✓ Gắn kết triết học – công nghệ – con người</p>
                  <p>✓ Tạo ra một thế hệ sinh viên vừa có lý trí, vừa có nhân cách, vừa có kỹ năng công nghệ</p>
                </div>
                <div className="mt-8 p-6 bg-white/10 rounded-xl border border-white/20">
                  <p className="text-2xl italic font-semibold">"AI không làm thay, AI giúp ta nghĩ tốt hơn."</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/95 backdrop-blur shadow-2xl border-2 border-slate-200">
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <h2 className="text-3xl font-bold text-primary mb-4">📜 7. Liên hệ và góp ý</h2>
                <p className="text-lg text-slate-700 mb-6">
                  Nếu bạn phát hiện nội dung sai lệch, thiếu chuẩn mực, hoặc muốn đóng góp ý tưởng để AI phục vụ tri thức tốt hơn,
                </p>
                <p className="text-xl font-semibold text-slate-900 mb-4">👉 Hãy gửi phản hồi về</p>
                <a 
                ...
                <p className="text-slate-600 mt-6">
                  Chúng tôi luôn trân trọng mọi đóng góp để làm cho Triết học 4.0 ngày càng hoàn thiện và nhân văn hơn.
                </p>
              </CardContent>
            </Card>
          </div>
