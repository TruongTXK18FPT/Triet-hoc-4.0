...
export function ChatbotWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "model",
      content:
        "Xin chào! Ta là Vua Triết AI — người bạn đồng hành trên hành trình khám phá triết học và chủ nghĩa Mác–Lênin.",
    },
  ]);
      ...
      try {
        ...
        setMessages((prev) => [
          ...prev,
          {
            ...
            role: "model",
            content:
              "Xin lỗi, ta đang bận xử lý luồng tư duy. Hãy thử lại sau một lát nhé.",
          },
        ]);
      }
    });
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed bottom-24 right-6 z-50 w-[85vw] sm:w-[90vw] max-w-[400px] sm:max-w-[440px] rounded-3xl border border-amber-200/70 
        ...
        >
          {/* Header */}
          <div
            className="relative flex items-center justify-between p-3 border-b border-amber-100/70 
              ...
              <div className="p-4 space-y-4">
                {messages.map((m) => (
                  ...
                  >
                    {m.role === "user" ? (
                      <div
                        className="max-w-[80%] bg-gradient-to-tr from-amber-500 to-yellow-400 text-white 
                      ...
                      <div
                        className="max-w-[80%] bg-white/90 border border-amber-100 rounded-2xl rounded-bl-none p-3 text-sm shadow-md 
