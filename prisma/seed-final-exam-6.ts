...
async function main() {
  ...
  const { finalExam6Questions } = await import('./final-exam-6-data');

  console.log(`📝 Creating quiz with ${finalExam6Questions.length} questions...`);
  ...
  for (const q of finalExam6Questions) {
