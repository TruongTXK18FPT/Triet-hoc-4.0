...
async function main() {
  ...
  const { finalExam5Questions } = await import('./final-exam-5-data');

  console.log(`📝 Creating quiz with ${finalExam5Questions.length} questions...`);
  ...
  for (const q of finalExam5Questions) {
