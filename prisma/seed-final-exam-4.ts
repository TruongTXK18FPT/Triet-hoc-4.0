...
async function main() {
  ...
  const { finalExam4Questions } = await import('./final-exam-4-data');

  console.log(`📝 Creating quiz with ${finalExam4Questions.length} questions...`);
  ...
  for (const q of finalExam4Questions) {
